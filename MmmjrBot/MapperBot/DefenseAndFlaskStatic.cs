...
namespace MmmjrBot
{
    public static class DefenseAndFlaskStatic
    {
        public static string LifeFlaskEffect = "flask_effect_life";
        public static string ManaFlaskEffect = "flask_effect_mana";
        public static string EnduringManaFlaskEffect = "flask_effect_mana_not_removed_when_full";
        public static string QsilverEffect = "flask_utility_sprint";
        ...
        public static async Task<bool> Run()
        {
            ...
            #region Flasks
            foreach (var flask in MmmjrBotSettings.Instance.MapperFlasks)
            {
            ...
            #region Defense
            foreach (var skill in MmmjrBotSettings.Instance.MapperDefensiveSkills)
            {
        ...
        private static bool HasFlaskEffect(Item thisflask)
        {
