        ...
        public static async Task<bool> KillAlira()
        {
            ...
            if (World.Act2.WesternForest.IsCurrentArea)
            {
                ...
                if (aliraPos != null)
                {
                    ...
                    if (await Helpers.StopBeforeBoss(MmmjrBotSettings.BossNames.Alira))
                        return true;
        ...
        public static async Task<bool> KillKraityn()
        {
            ...
            if (World.Act2.BrokenBridge.IsCurrentArea)
            {
                ...
                if (kraitynPos != null)
                {
                    ...
                    if (await Helpers.StopBeforeBoss(MmmjrBotSettings.BossNames.Kraityn))
                        return true;
        ...
        public static async Task<bool> KillOak()
        {
            ...
            if (World.Act2.Wetlands.IsCurrentArea)
            {
                ...
                if (oakPos != null)
                {
                    ...
                    if (await Helpers.StopBeforeBoss(MmmjrBotSettings.BossNames.Oak))
                        return true;
