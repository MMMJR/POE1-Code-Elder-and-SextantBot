    ...
    public static class A1_Q2_MercyMission
    {
        ...
        public static async Task<bool> TakeReward()
        {
            if (World.Act1.LioneyeWatch.IsCurrentArea)
            {
                ...
                {
                    var reward = MmmjrBotSettings.Instance.GetRewardForQuest(Quests.MercyMission.Id + "b");
                ...
                {
                    var reward = MmmjrBotSettings.Instance.GetRewardForQuest(Quests.MercyMission.Id);
