...
using MmmjrBot.QuestBot.QuestHandlers;
...
namespace MmmjrBot.QuestBot
{
    public static class QuestManager
    {
        ...
        public static QuestHandler GetQuestHandler()
        {
            ...
            if (MmmjrBotSettings.Instance.CheckGrindingFirst)
            {
            ...
            if (MmmjrBotSettings.Instance.IsQuestEnabled(quest))
            {
                if (QuestIsNotCompleted(quest))
                {
                    if (CurrentAct != act)
            ...
            if (MmmjrBotSettings.Instance.IsQuestEnabled(Quests.QueenOfSands)) // controlled by Queen of Sands
            {
                if (QuestIsNotCompleted(quest))
                {
                    if (CurrentAct != act)
        ...
        {
            MmmjrBotSettings.Instance.CurrentQuestName = questName;
            MmmjrBotSettings.Instance.CurrentQuestState = questState;
        ...
        private static QuestHandler GetGrindingHandler(int questIndex)
        {
            ...
            foreach (var rule in MmmjrBotSettings.Instance.GrindingRules)
            {
        ...
        private static QuestHandler AnalyzeBandits()
        {
            ...
            var chosenBandit = MmmjrBotSettings.Instance.GetRewardForQuest(quest.Id);
