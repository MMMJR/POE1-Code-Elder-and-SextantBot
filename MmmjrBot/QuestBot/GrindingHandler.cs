...
namespace MmmjrBot.QuestBot
{
    public static class GrindingHandler
    {
        ...
        private static MmmjrBotSettings.GrindingRule _grindingRule;
        ...
        {
            if (MmmjrBotSettings.Instance.UseHideout && ReturnAfterTownrunTask.Enabled && World.CurrentArea.IsHideoutArea)
            {
        ...
        internal static void SetGrindingRule(MmmjrBotSettings.GrindingRule rule)
        {
