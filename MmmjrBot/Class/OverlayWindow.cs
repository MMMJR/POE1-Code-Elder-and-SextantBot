...
namespace MmmjrBot.Class
{
	public class OverlayWindow : IDisposable
    {
		...
		private void _window_DrawGraphics(object sender, DrawGraphicsEventArgs e)
		{
            ...
            gfx.DrawTextWithBackground(_fonts["consolas"], _brushes["white"], _brushes["transparent_black"], MmmjrBotSettings.Instance.OverlayXCoord, MmmjrBotSettings.Instance.OverlayYCoord, botInfoText);
