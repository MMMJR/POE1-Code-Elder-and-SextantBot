...
namespace MmmjrBot
{
    public class CastAuraTask : ITask
    {
        ...
        private static List<Skill> GetAurasForCast()
        {
            ...
            {
                if (MmmjrBotSettings.Instance.IgnoreHiddenAuras && !aura.IsOnSkillBar)
                    continue;
        ...
        private static IEnumerable<Skill> AllWhitelistedAuras
        {
            get
            {
                ...
                (AuraNames.Contains(skill.Name) || AuraInternalId.Contains(skill.InternalId) || skill.IsAurifiedCurse || 
                 (MmmjrBotSettings.Instance.EnableAspectsOfTheAvian && skill.Name == "Aspect of the Avian") ||
                 (MmmjrBotSettings.Instance.EnableAspectsOfTheCat && skill.Name == "Aspect of the Cat") ||
                 (MmmjrBotSettings.Instance.EnableAspectsOfTheCrab && skill.Name == "Aspect of the Crab") ||
                 (MmmjrBotSettings.Instance.EnableAspectsOfTheSpider && skill.Name == "Aspect of the Spider")
                ));
            }
        }
        ...
        private static bool PlayerHasAura(Skill aura)
        {
            ...
            if (aura.InternalId == "blood_sand_armour")
            {
                ...
                if (MmmjrBotSettings.Instance.BloorOrSand == MmmjrBotSettings.BloodAndSand.Sand)
