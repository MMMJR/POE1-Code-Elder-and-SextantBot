...
namespace MmmjrBot
{
    public static class CastAuraTaskStatic
    {
        private static int MinGolemHpPercent = 80;
        ...
        public static async Task<bool> Run()
        {
            ...
            if (MmmjrBotSettings.Instance.UseStalkerSentinel)
            {
        ...
        private static List<Skill> GetAurasForCast()
        {
            ...
            {
                if (MmmjrBotSettings.Instance.MapperIgnoreHiddenAuras && !aura.IsOnSkillBar)
                    continue;
        ...
        private static IEnumerable<Skill> AllWhitelistedAuras
        {
            get
            {
                ...
                (AuraNames.Contains(skill.Name) || AuraInternalId.Contains(skill.InternalId) || skill.IsAurifiedCurse || 
                 (MmmjrBotSettings.Instance.EnableMapperAspectsOfTheAvian && skill.Name == "Aspect of the Avian") ||
                 (MmmjrBotSettings.Instance.EnableMapperAspectsOfTheCat && skill.Name == "Aspect of the Cat") ||
                 (MmmjrBotSettings.Instance.EnableMapperAspectsOfTheCrab && skill.Name == "Aspect of the Crab") ||
                 (MmmjrBotSettings.Instance.EnableMapperAspectsOfTheSpider && skill.Name == "Aspect of the Spider")
                ));
            }
        }
        ...
        private static bool PlayerHasAura(Skill aura)
        {
            ...
            if (aura.InternalId == "blood_sand_armour")
            {
                ...
                if (MmmjrBotSettings.Instance.MapperBloorOrSand == MmmjrBotSettings.BloodAndSand.Sand)
