...
namespace MmmjrBot.Lib
{
    public static class Events
    {
        ...
        public static void Tick()
        {
            ...
            {
                /*if (MmmjrBotSettings.Instance.SingleUseElderFragments && World.CurrentArea.IsMap)
                {
                    CombatAreaCache.Current.Explorer.HandleExternalJump();
                ...
                {
                    TransitionTriggerTaskStatic.Reset(areaName);
                }
        ...
        public static void FireEventsFromMessage(DreamPoeBot.Loki.Bot.Message message)
        {
            switch (message.Id)
            {
