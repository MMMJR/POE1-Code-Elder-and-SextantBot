...
namespace MmmjrBot.Lib
{
    public class Settings : JsonSettings
    {
        ...
        public int StrongboxOpenRange { get; set; } = 50;
        public int ShrineOpenRange { get; set; } = 50;
        ...
        public int MaxStuckCountSmall { get; set; } = 12;
        public int MaxStuckCountMedium { get; set; } = 18;
        public int MaxStuckCountLong { get; set; } = 40;
