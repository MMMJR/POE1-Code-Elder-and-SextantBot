...
namespace MmmjrBot.Lib
{
    ...
    public static class CurrencyNames
    {
        ...
        [ItemMetadata("Metadata/Items/Currency/CurrencyItemiseSextantModifier")]
        public static readonly string SurveyorsCompass;

        [ItemMetadata("Metadata/Items/Maps/MapWorldsHydra")]
        public static readonly string LairOfTheHydra;

        [ItemMetadata("Metadata/Items/Maps/MapWorldsPhoenix")]
        public static readonly string ForgeOfThePhoenix;

        [ItemMetadata("Metadata/Items/Maps/MapWorldsMinotaur")]
        public static readonly string MazeOfMinotaur;

        [ItemMetadata("Metadata/Items/Maps/MapWorldsChimera")]
        public static readonly string PitOfChimera;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyShaperFragment3")]
        public static readonly string FragmentOfChimera;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyShaperFragment2")]
        public static readonly string FragmentOfMinotaur;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyShaperFragment4")]
        public static readonly string FragmentOfHydra;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyShaperFragment1")]
        public static readonly string FragmentOfPhoenix;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyElderFragment3")]
        public static readonly string FragmentOfConstriction;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyElderFragment4")]
        public static readonly string FragmentOfPurification;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyElderFragment1")]
        public static readonly string FragmentOfEnslavement;

        [ItemMetadata("Metadata/Items/MapFragments/CurrencyElderFragment2")]
        public static readonly string FragmentOfEradication;
