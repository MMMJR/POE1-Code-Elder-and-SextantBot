...
namespace MmmjrBot
{
    public class QuestDefenseAndFlask : ITask
    {
        ...
        public async Task<bool> Run()
        {
            ...
            #region Flasks
            foreach (var flask in MmmjrBotSettings.Instance.QuestFlasks)
            {
            ...
            #region Defense
            foreach (var skill in MmmjrBotSettings.Instance.QuestDefensiveSkills)
            {
