    ...
    class TravelToPartyZoneTask : ITask
    {
        ...
        public async Task<bool> Run()
        {
            ...
            else
            {
                ...
                //{
                //    if (MmmjrBotSettings.Instance.DontPortOutofMap) return false;
                //}
            ...
            if (!curZone.IsTown && !curZone.IsHideoutArea && MmmjrBotSettings.Instance.DontPortOutofMap) return false;
