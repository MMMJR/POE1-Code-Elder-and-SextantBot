    ...
    public class DefenseAndFlaskTask : ITask
    {
        ...
        public async Task<bool> Run()
        {
            ...
            if (ShouldTeleport)
            {
                ...
                if (MmmjrBot._leaderPartyEntry != null && MmmjrBot._leaderPartyEntry.PlayerEntry != null)
                {
                    var leadername = MmmjrBot._leaderPartyEntry.PlayerEntry.Name;
            ...
            #region Flasks
            foreach (var flask in MmmjrBotSettings.Instance.Flasks)
            {
            ...
            #region Defense
            foreach (var skill in MmmjrBotSettings.Instance.DefensiveSkills)
            {
        ...
        private static void CastDefensiveSkill(DefensiveSkillsClass skillClass)
        {
            ...
            if (skill != null && skill.CanUse())
            {
                ...
                {
                    var leader = MmmjrBot.Leader;
                    if (leader != null && leader.Distance < 50)
                    {
                        LokiPoe.InGameState.SkillBarHud.UseOn(skill.Slot, false, MmmjrBot.Leader, false);
                        skillClass.Casted();
                    }
                }
                else
